               ...
               <div class="row check-box-container my-checkbox">
                ...
                <div class="row">
                    <div class="col-md-2 p-0 div-lab">
                        <?= $form->field($model, 'portada')->fileInput([!$model ? "required" : "" => !$model ? "required" : "", 'id' => 'inputfile', 'value' => $model->portada])->label("PORTADA") ?>
                    </div>
                    <div class="col-md-2 p-0 div-lab">
                        <?= $form->field($galeria, 'foto_2')->fileInput([!$model ? "required" : "" => !$model ? "required" : "", 'id' => 'inputfile2'])->label("SUBIR") ?>
                    </div>
                    <div class="col-md-2 p-0 div-lab">
                        <?= $form->field($galeria, 'foto_3')->fileInput([!$model ? "required" : "" => !$model ? "required" : "", 'id' => 'inputfile3'])->label("SUBIR") ?>
                    </div>
                    <div class="col-md-2 p-0 div-lab">
                        <?= $form->field($galeria, 'foto_4')->fileInput([!$model ? "required" : "" => !$model ? "required" : "", 'id' => 'inputfile4'])->label("SUBIR") ?>
                    </div>
                    <div class="col-md-2 p-0 div-lab">
